  ...
  return (
    <>
      <div className={styles.preciosContainer}>
        <h1 className={styles.preciosTitle}>{t("common:precios")}</h1>
        ...
        <div className={styles.preciosTable}>
          <div className={styles.preciosNav}>
            <a
              ...
              className={`styles.preciosTitles ${
                active1 ? styles.active : styles.inactive
              }`}
            >
              Sesiones Libres
            </a>
          ...
          <div className={styles.preciosListado}>
            ...
            {TipoDeCuota === "material" && (
              ...
              >
                <section className={styles.priceList}>
                  <p>{t("common:magnesioPeq")} 6'5€</p>
                  <p>{t("common:magnesioGrande")} 12€</p>
