    ...
    <>
      <div className={styles.footerWrap}>
        <div className={styles.footerMenu}>
          ...
          <Link href="/servicios-deportivos/escuela-de-escalada">
            <a className={styles.secondaryLink}>
              - Escuela Infantil y de Adultos
            </a>
          </Link>
          <Link href="/servicios-deportivos/formacion-tecnica">
            <a className={styles.secondaryLink}>
              - Formación Técnica y Deportiva
            </a>
          </Link>
          ...
          <Link href="/servicios-profesionales#trabajos-tecnicos-de-montana">
            <a className={styles.secondaryLink}>
              - Trabajos Técnicos de montaña
            </a>
          </Link>
          <Link href="/servicios-profesionales">
            <a className={styles.secondaryLink}>
              - Trabajos Locales en Entorno Urbano
            </a>
          </Link>
          ...
          <Link href="/servicios-profesionales">
            <a className={styles.secondaryLink}>
              - Equipamiento Deportivo de Montaña
            </a>
          </Link>
          ...
          <div className={styles.socialBanner}>
            ...
            <div className={styles.socialBannerLinkWrap}>
              <Link href="https://www.facebook.com/sala.tagorock">
                <a className={styles.socialBannerLink} target="_blank">
                  <Image src={Facebook} layout="fixed" width={40} height={40} />
                </a>
              </Link>
            </div>
            <div className={styles.socialBannerLinkWrap}>
        ...
        <div className={styles.footerContactWrap}>
          <h3 className={styles.contactTitle}>{t("common:contacto")}</h3>
          <Link href="mailto:tagorockmundovertical@gmail.com?subject=Solicitud%20de%20cita:">
            <a className={styles.contactEmailWrap}>
              <div className={styles.contactEmailLogo}>
                <Image src={Gmail} alt="gmail" />
              </div>
              <p className={styles.contactEmail}>
                tagorockmundovertical@gmail.com
              </p>
            </a>
          </Link>
          <Link href="/">
            <a
              className={styles.contactWhatsappWrap}
              target="_blank"
              rel="noopener noreferrer"
              href="https://api.whatsapp.com/send?phone=34628020152"
            >
